...
<html>
<head>
<title>SMS Bomber | TricksCity</title>
<?php
 if($tel_no){
...
<div class="panel panel-success" style="margin-bottom: 0px;">
	...
	<form method='GET' action='index.php'>
		...
		To STOP SMS Bombing Just Close This Tab.<br /><br />
...
<!-- http://www.trickscity.com/ START (hidden counter)-->
...
<style>
display:none;
<a href="http://www.trickscity.com/">TricksCity</a>
</style>
